package net.runelite.client.plugins.zulrahoverlay.rotationutils;

import com.google.common.collect.ImmutableList;
import net.runelite.client.plugins.zulrahoverlay.constants.StandLocation;
import net.runelite.client.plugins.zulrahoverlay.constants.ZulrahLocation;
import net.runelite.client.plugins.zulrahoverlay.constants.ZulrahType;

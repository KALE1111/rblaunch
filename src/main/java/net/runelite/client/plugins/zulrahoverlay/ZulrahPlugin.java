package net.runelite.client.plugins.zulrahoverlay;

import com.google.common.base.Preconditions;
import com.google.inject.Provides;
import net.runelite.client.plugins.zulrahoverlay.rotationutils.RotationType;
import net.runelite.client.plugins.zulrahoverlay.overlays.*;
import net.runelite.client.plugins.zulrahoverlay.rotationutils.ZulrahData;
import net.runelite.client.plugins.zulrahoverlay.rotationutils.ZulrahPhase;
...
@Slf4j
@PluginDescriptor(
		name = "<html><font color=#86C43F>[RB]</font> Zulrah</html>",

...
import net.runelite.client.plugins.RawKarambwanji.UiLayoutOption;
...
public class KarambwanjiOverlay extends OverlayPanel {

    private final KarambwanjiPlugin plugin;

    @Inject
    public KarambwanjiOverlay(KarambwanjiPlugin plugin) {
        this.plugin = plugin;
    ...
    private void addSimpleOverlay() {
        ...
        String title = "[RB] Karambwanji v1.0";

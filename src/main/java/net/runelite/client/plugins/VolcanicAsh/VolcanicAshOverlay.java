...
import net.runelite.client.plugins.VolcanicAsh.VolcanicAshPlugin;
...
public class VolcanicAshOverlay extends OverlayPanel {

    private final VolcanicAshPlugin plugin;

    @Inject
    public VolcanicAshOverlay(VolcanicAshPlugin plugin) {
        this.plugin = plugin;
...
//                .build());
    ...
    private void addSimpleOverlay() {
        ...
        String title = "[RB] Volcanic Ash v1.0";
